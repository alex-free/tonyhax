...
// Biohazard Gun Survivor
   	if((strcmp("cdrom:\\SLPS_025.53;1", bootfile)) == 0) {
   		#if !defined STEALTH
			//debug_write("Detected Bio Hazard Gun Survivor");
		#endif
		/*
		D0017962 1040
		80017962 1000
...
// Tomba!
   	if((strcmp("cdrom:\\SCUS_942.36;1", bootfile)) == 0) {
   		#if !defined STEALTH
			//debug_write("Detected TOMBA!");
		#endif
		/*
		D016240E 1040
		8016240E 1000
		code from copyconsoleworld: https://consolecopyworld.com/psx/psx_game_codes_t.shtml
		*/
 		enable_code_1(0x8016240E, 0x1000, 0x1040);
    	install_cheat_engine();
    }
