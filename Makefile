...
PACKAGE_CONTENTS = $(ENTRY_FILES:%=entrypoints/%) $(ROM_FILES:%=rom/%) loader/HAX loader/FF9 loader/tonyhax.mcs loader/tonyhax-ff9.mcs loader/tonyhax.exe $(FREEPSXBOOT_IMAGES:%=freepsxboot/%) $(BOOT_CD_FILES:%=boot-cd/%) gshax/wipeout-usa/wipeout-usa-gshax-code.txt gshax/wipeout-usa/CODELIST00 gshax/parasite-eve-usa/parasite-eve-usa-gshax-code.txt gshax/parasite-eve-usa/CODELIST00 *.md images/*.jpg LICENSE
