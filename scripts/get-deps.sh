...
if command -v dnf &> /dev/null; then
    ...
    sudo apt install --yes build-essential libtinyxml2-dev git cmake cdrdao python3 python3-pip autoconf texinfo help2man gawk libtool-bin libtool ncurses-dev gcc-multilib ming-w64
else
